...
# put_object
response = s3Client.put_object(Body=putMessage, Bucket="das-demos", Key="boto3put.txt")

print(response)

# copy
toCopy = {"Bucket": "das-demos", "Key": "boto3put.txt"}

s3Resource.meta.client.copy(toCopy, "das-demos", "boto3copy.txt")

# copy_object
response = s3Client.copy_object(
    Bucket="das-demos", CopySource="/das-demos/boto3put.txt", Key="boto3copyobject.txt"
)
